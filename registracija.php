...
<div class="forma" style="margin-top: 50px">
    <form method="post" id="formaRegistracija">
        ...
        <div class="input-group mb-3 container">
            <input class="form-control" type="date" name="datumrodj" value="">
        </div>
        ...
        <div class="d-grid gap-2 d-md-block">
            <button type="submit" id="registrujSe" class="btn btn-success" style="background-color: rgb(255, 122, 127, .8); border: none">Napravi nalog</button>
            <button type="reset" class="btn btn-primary"style="background-color: rgb(255, 122, 127, .8); border: none">Resetuj formu</button>
            <button type="button" onclick="document.location.href='index.php'" class="btn btn-danger" style="background-color: rgb(255, 122, 127, .8); border: none" >Otkaži</button>
        </div>
